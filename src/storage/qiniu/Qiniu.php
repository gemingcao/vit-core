...
namespace vitphp\admin\storage\qiniu;
...
class Qiniu
{
     ...
     * @throws \Exception
     */
    public function uploadFile($accesskey, $secretkey,$bucket,$key,$filePath){
        //auth 鉴权
       $auth = $this->auth($accesskey, $secretkey);
     ...
     * @throws \Exception
     */
    public function uploadFileTest($key,$filePath,$accesskey,$secretkey,$bucket,$url){
...
//        echo "\n====> pfop avthumb status: \n";
     ...
     * @return mixed
     */
    public function delFile($key,$bucket,$accesskey,$secretkey){
        $auth = $this->auth($accesskey,$secretkey);
//        $config = new Config();
        $bucketManager = new BucketManager($auth);
//        echo json_encode(array('code'=>$key,'bucket'=>$bucket,'Accesskey'=>$accesskey,'skey'=>$secretkey,'config'=>$bucketManager));exit;
